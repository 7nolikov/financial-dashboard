...
const presets = {
    ...
    incomes: [
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 22, monthIndex: 22 * 12 },
          end: { ageYears: 28, monthIndex: 28 * 12 },
          everyMonths: 1,
        },
        category: 'employment',
      },
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 28, monthIndex: 28 * 12 },
          end: { ageYears: 35, monthIndex: 35 * 12 },
          everyMonths: 1,
        },
        category: 'employment',
      },
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 35, monthIndex: 35 * 12 },
          end: { ageYears: 50, monthIndex: 50 * 12 },
          everyMonths: 1,
        },
        category: 'employment',
      },
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 50, monthIndex: 50 * 12 },
          end: { ageYears: 65, monthIndex: 65 * 12 },
          everyMonths: 1,
        },
        category: 'employment',
      },
    ...
    loans: [
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 22, monthIndex: 22 * 12 },
          end: { ageYears: 30, monthIndex: 30 * 12 },
          everyMonths: 1,
        },
    ...
    investments: [
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 25, monthIndex: 25 * 12 },
          end: { ageYears: 65, monthIndex: 65 * 12 },
          everyMonths: 1,
        },
    ...
    incomes: [
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 24, monthIndex: 24 * 12 },
          end: { ageYears: 55, monthIndex: 55 * 12 },
          everyMonths: 1,
        },
        category: 'employment',
      },
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 26, monthIndex: 26 * 12 },
          end: { ageYears: 55, monthIndex: 55 * 12 },
          everyMonths: 12,
        },
        category: 'employment',
      },
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 30, monthIndex: 30 * 12 },
          everyMonths: 1,
        },
        category: 'investment',
      },
    ...
    expenses: [
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 28, monthIndex: 28 * 12 },
          end: { ageYears: 58, monthIndex: 58 * 12 },
          everyMonths: 1,
        },
      },
      {
    ...
    incomes: [
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 30, monthIndex: 30 * 12 },
          end: { ageYears: 60, monthIndex: 60 * 12 },
          everyMonths: 1,
        },
        category: 'business',
      },
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 40, monthIndex: 40 * 12 },
          everyMonths: 1,
        },
        category: 'passive',
      },
    ...
    loans: [
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 30, monthIndex: 30 * 12 },
          end: { ageYears: 45, monthIndex: 45 * 12 },
          everyMonths: 1,
        },
    ...
    investments: [
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 32, monthIndex: 32 * 12 },
          end: { ageYears: 60, monthIndex: 60 * 12 },
          everyMonths: 1,
        },
      ...
      },
      {
        ...
        model: { type: 'fixed', fixedRate: 0.1 },
      },
    ],
    safetySavings: [
      {
  ...
  // "Gig Worker 2026" — the new economic reality: no employer pension, variable
  // income, high housing costs, no safety net. Reflects millions of Europeans
  // in the platform/gig economy (delivery, ride-hailing, freelance tech).
  gig: (): CoreState => ({
    version: CURRENT_VERSION,
    dobISO: '1997-01-01', // age ~29 — peak gig workforce demographic
    incomes: [
      {
        id: 'inc-gig',
        label: 'Gig Platform Income (variable)',
        amount: 2200, // ~€26.4k/yr — European gig worker median (before expenses)
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 20, monthIndex: 20 * 12 },
          end: { ageYears: 45, monthIndex: 45 * 12 },
          everyMonths: 1,
        },
      ...
      {
        id: 'inc-side',
        label: 'Freelance Side Projects',
        amount: 600, // Occasional freelance work
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 23, monthIndex: 23 * 12 },
          end: { ageYears: 40, monthIndex: 40 * 12 },
          everyMonths: 1,
        },
        category: 'self-employment',
      },
      {
        id: 'inc-employed',
        label: 'Part-time Employment (later)',
        amount: 2800, // Transition to employed work for stability
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 35, monthIndex: 35 * 12 },
          end: { ageYears: 67, monthIndex: 67 * 12 },
          everyMonths: 1,
        },
        category: 'employment',
      },
    ...
    expenses: [
      ...
      {
        id: 'exp-transport',
        label: 'Transport & Bike Maintenance',
        amount: 180,
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 20, monthIndex: 20 * 12 },
    ...
    loans: [
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 22, monthIndex: 22 * 12 },
          end: { ageYears: 24, monthIndex: 24 * 12 },
          everyMonths: 1,
        },
        interestRate: 0.12,
        category: 'consumer',
    ...
    investments: [
      {
        id: 'inv-etf',
        label: 'ETF (when affordable)',
        principal: 0,
        recurringAmount: 100, // Can barely save — no employer match
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 28, monthIndex: 28 * 12 },
          end: { ageYears: 67, monthIndex: 67 * 12 },
    ...
    inflation: {
      mode: 'single',
      baseYear: new Date().getFullYear(),
      singleRate: 0.03, // Higher inflation expectation for 2026+
      yearlyRates: undefined,
      display: { seriesMode: 'nominal' },
    },
    chart: { zoom: { minMonth: 0, maxMonth: 100 * 12 } },
  ...
  average: (): CoreState => ({
    ...
    incomes: [
      ...
      },
      {
        ...
        recurrence: {
          kind: 'recurring',
          start: { ageYears: 67, monthIndex: 67 * 12 },
          everyMonths: 1,
        },
        category: 'government',
      },
