      ...
      <div className="bg-slate-50 px-5 py-4 border-b border-slate-200">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-600 mt-1">
            Configure safety savings and investment defaults
          </p>
        </div>
      </div>
          ...
          <div className="space-y-6">
            <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-200">
              ...
              <p className="text-sm text-indigo-700 mb-4">
                Define emergency fund targets for different life stages. The chart will show when
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-slate-600">
                          {r.monthsCoverage} months × €{r.monthlyExpenses.toLocaleString()}/month =
                          €{(r.monthsCoverage * r.monthlyExpenses).toLocaleString()} target
                        </div>
                        <div className="text-xs text-slate-500">
                          Starts at age {r.start.ageYears}
                        </div>
                      </div>
                    </div>
                    <button
          ...
          <div className="space-y-6">
            <div className="bg-green-50 rounded-xl p-6 border border-green-200">
              ...
              <p className="text-sm text-green-700 mb-4">
                Set the default expected return rate for new investments. This helps estimate
                long-term growth.
              </p>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      min="0"
                      max="50"
                      className="flex-1 border border-slate-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                      defaultValue={6.5}
                      placeholder="6.5"
                      onChange={(e) => {
                ...
                <div className="bg-white rounded-lg p-4 border border-green-100">
                  ...
                  <div className="text-sm text-slate-600 space-y-1">
                    <div>
                      • <strong>Conservative (3-5%):</strong> Bonds, CDs, savings accounts
                    </div>
                    <div>
                      • <strong>Moderate (6-8%):</strong> Balanced funds, index funds
                    </div>
                    <div>
                      • <strong>Aggressive (8-12%):</strong> Stock market, growth funds
                    </div>
                    <div>
                      • <strong>Historical S&P 500:</strong> ~10% annually (with volatility)
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
              ...
              <div className="text-sm text-slate-700 space-y-2">
                <div>
                  • <strong>Emergency Fund:</strong> 3-6 months of expenses
                </div>
                <div>
                  • <strong>Safety Target:</strong> Shows when you have enough savings
                </div>
                <div>
                  • <strong>Investment Returns:</strong> Use conservative estimates for planning
                </div>
                <div>
                  • <strong>Inflation:</strong> Consider real vs nominal returns
                </div>
              </div>
            </div>
          </div>
