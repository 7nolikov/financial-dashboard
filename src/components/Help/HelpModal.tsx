...
export function HelpModal({ isOpen, onClose }: HelpModalProps) {
  // Radix Dialog gives us Escape-to-close, a focus trap, scroll lock and focus
  // restoration for free — none of which the old hand-rolled overlay had. It
  // also portals to <body>, so the sticky header's backdrop-blur can't clip it.
  return (
    <Dialog.Root open={isOpen} onOpenChange={(o) => !o && onClose()}>
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:fade-in data-[state=closed]:fade-out" />
        <Dialog.Content
          aria-describedby={undefined}
          className="fixed left-1/2 top-1/2 z-50 w-[calc(100%-1rem)] sm:w-full max-w-5xl max-h-[96vh] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-2xl sm:rounded-3xl bg-white shadow-2xl border border-slate-200 focus:outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:fade-in data-[state=closed]:fade-out data-[state=open]:zoom-in-95"
        >
          {/* Header */}
          <div className="bg-indigo-600 px-4 sm:px-8 py-4 sm:py-6 text-white">
            <div className="flex justify-between items-center gap-3">
              <div>
                <Dialog.Title className="text-xl sm:text-3xl font-bold mb-1 sm:mb-2">
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-emerald-100">
                    ...
                    <p className="text-sm text-slate-600">
                      Enter your birth date to align the timeline with your actual age.
                    </p>
                  </div>
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-emerald-100">
                    <div className="text-emerald-600 font-semibold mb-2">3. Customize Data</div>
                    <p className="text-sm text-slate-600">
                      Add your incomes, expenses, and investments using the data entry panel.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Enter your date of birth to align the timeline with your actual age.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Start with Worker, Investor, Businessman, or Loaner presets to see different
                        financial scenarios.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Use the Data Entry tabs to add incomes, expenses, investments, and
                        retirement plans.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Set safety savings rules, interest rates, and inflation settings.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        View your financial trajectory, zoom in/out, and add milestones.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3 p-3 rounded-xl bg-green-50 border border-green-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Plan your financial future by modeling different income, expense, and
                  ...
                  <div className="flex gap-3 p-3 rounded-xl bg-green-50 border border-green-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        See how buying a house, having kids, or changing careers affects your net
                        worth.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 rounded-xl bg-green-50 border border-green-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Determine if you're on track for retirement and adjust your savings
                        strategy.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 rounded-xl bg-green-50 border border-green-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Compare different investment strategies and their long-term impact.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 rounded-xl bg-green-50 border border-green-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Set financial milestones and track progress toward achieving them.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3 p-3 rounded-xl bg-orange-50 border border-orange-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        The purple line shows your net worth - the most important metric for
                        financial health.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 rounded-xl bg-orange-50 border border-orange-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Red shaded areas indicate periods when your net worth is negative - plan to
                        avoid these.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 rounded-xl bg-orange-50 border border-orange-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Switch between nominal (with inflation) and real (inflation-adjusted) views
                        to understand true purchasing power.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 rounded-xl bg-orange-50 border border-orange-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Scroll to zoom in on specific time periods for detailed analysis.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 rounded-xl bg-orange-50 border border-orange-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Green circles show peaks, red circles show troughs - important financial
                        milestones.
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-indigo-700 leading-relaxed">
                    ...
                    then customize it with your own data. Remember: this is for planning purposes
                    only and doesn't constitute financial advice.
                  </p>
                </div>
              </div>
            </div>
